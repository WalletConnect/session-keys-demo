...
async function signWithPasskey(challenge: Uint8Array): Promise<PublicKeyCredential | null> {
...
export { createPasskey, toLocalStorageFormat, isLocalStoragePasskey, signWithPasskey }
