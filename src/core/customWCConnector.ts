...
customWalletConnect.type = 'customwalletConnect' as const
export function customWalletConnect(parameters: WalletConnectParameters) {
  ...
  return createConnector<Provider, Properties, StorageItem>(config => ({
    id: 'customwalletConnect',
    name: 'CustomWalletConnect',
    type: customWalletConnect.type,
    async setup() {
